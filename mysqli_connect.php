...
DEFINE ('DB_USER', 'studentweb'); //<----------------user - probably root
DEFINE ('DB_PASSWORD', 'turtledove'); //<-------------------------your password
DEFINE ('DB_HOST', '127.0.0.1'); //<----------------- I use this instead of localhost
DEFINE ('DB_NAME', 'student'); //<-------------------- name of the database
